...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-center min-vh-100">
        <div class="row w-100 register-card bg-white overflow-hidden">
                ...
                <form action="{{ route('registerUser') }}" method="POST">
                    ...
                    <div class="text-center mt-4">
                        <small>Déjà un compte ?
                            <a href="{{ route('loginForm') }}" class="text-decoration-none fw-semibold">Se connecter</a>
                        </small>
                    </div>
            ...
            <div class="col-md-6 d-none d-md-flex align-items-center justify-content-center illustration">
                <div class="text-center p-4">
                    ...
                    <p class="text-muted">Créez votre colocation et simplifiez vos remboursements.</p>
